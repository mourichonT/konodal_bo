...
export default function EvenementsCalendarPage() {
  ...
  // aux compteurs de prestations ci-dessus.
        ...
        <div className="grid flex-1 grid-cols-2 gap-4">
          ...
          <Card className="rounded-2xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
            <CardContent className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-0.5">
                <span className="text-sm text-muted-foreground">Prestations programmées</span>
        ...
        <div className="grid flex-1 grid-cols-2 gap-4">
          ...
          <Card className="rounded-2xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
            <CardContent className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-0.5">
                <span className="text-sm text-muted-foreground">Résidences avec prestations à venir</span>
